...
public class BalanceServiceMock implements BalanceService {
    ...
    public List<Balance> getBalanceForWorkspace(String workspaceId) {
        ...
        List<WorkspaceMember> members = mockDataProvider.getWorkspaceMembers().getOrDefault(workspaceId, new ArrayList<>());
        ...
        if (memberCount > 0) {
            BigDecimal perPerson = totalAmount.divide(BigDecimal.valueOf(memberCount), 2, java.math.RoundingMode.HALF_UP);
