<template>
  ...
  >
      ...
      >
        ...
        <svg
          v-else-if="categorySlug === 'transportation'"
          fill="none"
          stroke="currentColor"
          viewBox="0 0 24 24"
          class="w-5 h-5 text-white/80"
        ...
        <svg
          v-else-if="categorySlug === 'internet'"
          fill="none"
          stroke="currentColor"
          viewBox="0 0 24 24"
          class="w-5 h-5 text-white/80"
...
const getCategoryGradient = (slug: string) => {
  ...
  return gradients[slug] || gradients.other
}
</script>
